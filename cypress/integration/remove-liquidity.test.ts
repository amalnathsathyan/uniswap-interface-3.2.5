describe('Remove Liquidity', () => {
  it('redirects', () => {
    cy.visit('/remove/0x6a119cbbdfcbeffd8ee87fb15dbbc25c2786ce0c-0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85')
    cy.url().should(
      'contain',
      '/remove/0x6a119cbbdfcbeffd8ee87fb15dbbc25c2786ce0c/0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85'
    )
  })
  ...
  it('does not crash if ETH is duplicated', () => {
    cy.visit('/remove/0x6a119cbbdfcbeffd8ee87fb15dbbc25c2786ce0c-0x6a119cbbdfcbeffd8ee87fb15dbbc25c2786ce0c')
    cy.get('#remove-liquidity-tokena-symbol').should('contain.text', 'WETH')
